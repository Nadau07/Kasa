    ...
    return(
       ...
       <div className='banner'>
        ...
        <div className='errorDivGlobal'>
            ...
            <p className="errorP1"><span className='errorP1Span'>Oups ! La page que</span> vous demandez n'existe pas.</p>
            <NavLink to={`/`} className='errorP2'>Retourner a la page d'accueil</NavLink>
        </div>
        <Footer />
        </div>
    )
